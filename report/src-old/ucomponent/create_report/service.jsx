...
function Service1({handleClose,reportdisplay}){
    ...
    const btn_submit = async (e) =>{
        ...
        let item = {c_cname,c_saddress,c_cperson,c_contact,r_cname,r_reported,r_cperson,r_contact,project,sano,caseno,se,datefrom,dateto,name,email,profile};

        let result = await fetch('http://'+local_host+'/api/auth/c_srreport',{
            method: 'POST',
            ...
            <div className="card-body">
                <div className="row">
                    <div className="col-md-6">
                        ...
                        <div className="form-group">
                            <label>Project</label>
                            <input onChange = {(e)=>sproject(e.target.value)} type="text" className="form-control" placeholder="Enter Project" required/>
                        </div>
                        <div className="form-group">
                            <label>SA No.</label>
                            <input onChange = {(e)=>ssano(e.target.value)} type="text" className="form-control" placeholder="Enter SA #" required/>
                        </div>
                        <div className="form-group">
                            <label>Case No.</label>
                            <input onChange = {(e)=>scaseno(e.target.value)} type="text" className="form-control" placeholder="Enter Case #" required/>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="row">
                    <div className="col-md-6 mb-3">                        
                        ...
                        <div className="form-group">
                            ...
                            <input onChange = {(e)=>sc_contact(e.target.value)} type="number" className="form-control" placeholder="Enter Contact #" required/>
                        </div>
                    </div>
                    <div className="col-md-6">
                        ...
                        <div className="form-group">
                            ...
                            <input onChange = {(e)=>sr_reported(e.target.value)} type="text" className="form-control" placeholder="Enter Reported by" required/>
                        </div>
                        <div className="form-group">
                            <label>Contact Person</label>
                            <input onChange = {(e)=>sr_cperson(e.target.value)} type="text" className="form-control" placeholder="Enter Contact Person" required/>
                        </div>
                        <div className="form-group">
                            <label>Contact No.</label>
                            <input onChange = {(e)=>sr_contact(e.target.value)} type="number" className="form-control" placeholder="Enter Contact #" required/>
                        </div>
                    </div>
                </div>
            </div>
