...
import Cancelreport from '../../../ucomponent/cancelreport/cancelreport';
...
function Recordlist({item,reportdisplay,htitle}){
    ...
    const showmodal = (mtype,value,rtype) =>{
        if(mtype===1){
            ...
            if(cancelRef.current){
                cancelRef.current.openmodal(value,rtype);
            }
        }else if(mtype===4){
            if(isBrowser){
                    ...
                    return(
                        <div className="d-flex justify-content-center dropdown">
                            ...
                            <ul className="dropdown-menu m-5" aria-labelledby="navbarDropdownMenuLink2">
                                ...
                                <li>
                                    <Link onClick={()=>showmodal(3,value,tableMeta.rowData[17])} className="dropdown-item">Cancel Report</Link>
                                </li>
                                {
                                    (tableMeta.rowData[18]) &&
                                    <li>
                                        <Link onClick={()=>showmodal(4,value,tableMeta.rowData[17])} className="dropdown-item">Download Report</Link>
                                    </li>
                                } 
                            </ul>
                        </div>
    ...
    return(
        <div className="mt-3">
            ...
            <Cancelreport ref={cancelRef} reportdisplay={reportdisplay}/>
