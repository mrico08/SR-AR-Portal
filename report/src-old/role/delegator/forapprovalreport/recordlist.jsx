...
// import Updatereport from '../../../ucomponent/updatereport/updatereport';
import Returntose from '../../../ucomponent/returntose/returntose';
import Approve from '../../../ucomponent/approve/approvereport';
...
function Recordlist({item,reporttype,htitle,reportdisplay}){
    ...
    const showmodal = (mtype,value,rtype) =>{
        ...
        // }
            ...
            if(returnRef.current){
                returnRef.current.openmodal(value,rtype);
            }
        }else if(mtype===4){
            if(approveRef.current){
                approveRef.current.openmodal(value,rtype);
            }
        }else if(mtype===5){
            if(isBrowser){
                    ...
                    return(
                        <div className="d-flex justify-content-center dropdown">
                            ...
                            <ul className="dropdown-menu m-5" aria-labelledby="navbarDropdownMenuLink2">
                                ...
                                {/* <li>
                                    <Link onClick={()=>showmodal(2,value,tableMeta.rowData[17])} className="dropdown-item">Edit Details</Link>
                                </li> */}
                                <li>
                                    <Link onClick={()=>showmodal(3,value,tableMeta.rowData[17])} className="dropdown-item">Return to Engineer</Link>
                                </li>
                                <li>
                                    <Link onClick={()=>showmodal(4,value,tableMeta.rowData[17])} className="dropdown-item">Approve Report</Link>
                                </li>
                                <li>
                                    <Link onClick={()=>showmodal(5,value,tableMeta.rowData[17])} className="dropdown-item">Download Report</Link>
                                </li>
    ...
    return( 
        <div className="mt-3">
            ...
            {/* <Updatereport ref={updateRef} reportdisplay={reportdisplay} /> */}
            <Returntose ref={returnRef} reportdisplay={reportdisplay} />
            <Approve ref={approveRef} reportdisplay={reportdisplay} />
