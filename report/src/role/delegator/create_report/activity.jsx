...
function Activity({handleClose,reportdisplay}){
    ...
    const btn_submit = async(e) =>{
        ...
        let item = {c_cname,c_saddress,c_cperson,c_contact,r_cname,r_requested,r_cperson,r_contact,designno,se,datefrom,dateto};
            ...
            <div className="card-body p-5">
                <div className="row">
                    ...
                    <div className="col-md-6">
                        ...
                        <div className="form-group">
                            <label>Contact No.</label>
                            <input onChange = {(e)=>sr_contact(e.target.value)} type="number" className="form-control" placeholder="Enter Contact No." required/>
                        </div>
                    </div>
                </div>
            </div>
