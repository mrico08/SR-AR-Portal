...
function Reportmodal({reportdisplay},ref){
            ...
            <DialogContent>
                ...
                </div>
                {
                    category === "Service Report" ?
                        <Service1 handleClose={handleClose} reportdisplay={reportdisplay}/>
                    :
                    category === "Activity Report" &&
                        <Activity handleClose={handleClose} reportdisplay={reportdisplay}/>
                }
            </DialogContent>
        </BootstrapDialog>
    )
